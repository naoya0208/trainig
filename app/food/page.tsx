...
function scaleMicros(m: MicroNutrients | undefined, r: number): MicroNutrients | undefined {
  ...
  return { fiber: s(m.fiber), vitaminD: s(m.vitaminD), vitaminB12: s(m.vitaminB12), vitaminC: s(m.vitaminC), iron: s(m.iron), calcium: s(m.calcium), zinc: s(m.zinc), omega3: s(m.omega3), sodium: s(m.sodium), potassium: s(m.potassium), water: s(m.water), vitaminE: s(m.vitaminE), vitaminA: s(m.vitaminA), biotin: s(m.biotin), vitaminB2: s(m.vitaminB2), niacin: s(m.niacin), pantothenicAcid: s(m.pantothenicAcid), magnesium: s(m.magnesium), selenium: s(m.selenium), vitaminK2: s(m.vitaminK2), vitaminB6: s(m.vitaminB6), folate: s(m.folate) };
}
function addMicros(a: MicroNutrients, b: MicroNutrients | undefined): MicroNutrients {
  ...
  return { fiber: add(a.fiber, b?.fiber), vitaminD: add(a.vitaminD, b?.vitaminD), vitaminB12: add(a.vitaminB12, b?.vitaminB12), vitaminC: add(a.vitaminC, b?.vitaminC), iron: add(a.iron, b?.iron), calcium: add(a.calcium, b?.calcium), zinc: add(a.zinc, b?.zinc), omega3: add(a.omega3, b?.omega3), sodium: add(a.sodium, b?.sodium), potassium: add(a.potassium, b?.potassium), water: add(a.water, b?.water), vitaminE: add(a.vitaminE, b?.vitaminE), vitaminA: add(a.vitaminA, b?.vitaminA), biotin: add(a.biotin, b?.biotin), vitaminB2: add(a.vitaminB2, b?.vitaminB2), niacin: add(a.niacin, b?.niacin), pantothenicAcid: add(a.pantothenicAcid, b?.pantothenicAcid), magnesium: add(a.magnesium, b?.magnesium), selenium: add(a.selenium, b?.selenium), vitaminK2: add(a.vitaminK2, b?.vitaminK2), vitaminB6: add(a.vitaminB6, b?.vitaminB6), folate: add(a.folate, b?.folate) };
}
